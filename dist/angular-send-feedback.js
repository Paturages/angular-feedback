 ...
 * @version v1.2.2 - 2016-07-18 * @link https://github.com/jacobscarter/angular-feedback
...
angular.module("angularsendfeedback.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("angularsendfeedback.html",
    "<div id=\"feedback-button\" ng-click=\"loadFeedback()\">\n" +
    "  <button class=\"feedback-btn feedback-btn-gray\">{{ options.initButtonText || 'Send feedback' }}</button>\n" +
    "</div>\n" +
    "");
}]);
    ...
    return {
        ...
        link: function($scope, $element, $attrs) {
            ...
            $scope.$watch('options', function(oldval, newval) {
              settings = $.extend(settings, $scope.options);
            });
